...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            @endif
            <span style="font-size: 24px">Thông tin <b>{{ $lead->name }}</b></span>
            <table class="table table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        <th>Ngày sinh</th>
                        <td>{{ $lead->dob ? \Carbon\Carbon::parse($lead->dob)->format('d/m/Y') : 'Chưa có thông tin' }}</td>
                    </tr>
                    <tr>
                        <th>Trạng thái</th>
                        <td>
                    ...
                    <tr>
                        <th>Ngày tạo</th>
                        <td>{{ $lead->created_at ? \Carbon\Carbon::parse($lead->created_at)->format('d/m/Y') : 'Chưa có thông tin' }}</td>
                    </tr>
                    <tr>
                        <th>Ngày cập nhật</th>
                        <td>{{ $lead->updated_at ? \Carbon\Carbon::parse($lead->updated_at)->format('d/m/Y') : 'Chưa có thông tin' }}</td>
                    </tr>
                </tbody>
            </table>
