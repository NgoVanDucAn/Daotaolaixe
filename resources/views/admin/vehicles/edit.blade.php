        ...
        <div class="card-body">
            <form action="{{ route('vehicles.update', $vehicle) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-12 col-md-4">
                        ...
                        <select name="ranking_id" class="form-control" required>
                            ...
                            @foreach($rankings as $ranking)
                                <option value="{{ $ranking->id }}" {{ old('ranking_id', $vehicle->ranking_id) == $ranking->id ? 'selected' : '' }}>
                                    {{ $ranking->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3 col-12 col-md-4">
                        <label>Số giấy phép tập lái</label>
                        <input type="text" name="training_license_number" class="form-control" value="{{ old('training_license_number', $vehicle->training_license_number) }}">
                    ...
                    <div class="mb-3 col-12 col-md-4">
                        ...
                        <input type="number" name="manufacture_year" class="form-control" value="{{ old('manufacture_year', $vehicle->manufacture_year) }}" required>
                    ...
                    <div class="mb-3 col-12 col-md-4">
                        <label>Ghi chú</label>
                        <textarea name="description" class="form-control">{{ old('description', $vehicle->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
