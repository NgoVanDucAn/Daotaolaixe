        ...
        <form method="GET" action="{{ route('students.index-moto') }}" class="row">
            ...
            <div class="col-12 col-lg-3 col-md-12 mb-2 mt-2">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-2">
                        <a href="{{ route('students.index-moto') }}" class="btn btn-outline-danger mb-1" id="clearFilters"><b><i class="mdi mdi-sync me-1"></i>Refresh</b></a>
                    </div>
                </div>
            </div>
        </form>
                        ...
                        @if($courseCount > 0)
                            @foreach ($student->courseStudents as $course)
                                <tr class="student-main-row" data-student-id="{{ $student->id }}">
                                    ...
                                    <td>{{ $student->phone }}</td>
                                    <td>
                                        {{ \Carbon\Carbon::parse($course->contract_date)->format('d/m/Y') }}
                                    </td>
                                    ...
                                    <td class="text-nowrap">
                                        ...
                                        <a href="{{ route('student.course.edit', ['student' => $student->id, 'course' => $course->course->id]) }}" class="btn btn-sm btn-warning m-1"><i class="fa-solid fa-user-pen"></i></a>
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 mb-3">
                                        ...
                                        <input type="text" name="tuition_fee" id="tuition_fee" class="form-control currency-input" value="{{ old('tuition_fee') }}" required>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="col-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select name="sale_id" id="add_sale_id" class="form-control @error('sale_id') is-invalid @enderror">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div id="exam-fields" class="mb-3" style="display: none;">
                                    ...
                                    <div class="form-group mb-3 position-relative">
                                        ...
                                        <input type="text" placeholder="dd/mm/yyyy"name="exam_fee_deadline" id="exam_fee_deadline" autocomplete="off" class="form-control real-date @error('exam_fee_deadline') is-invalid @enderror"/>
...
<script>
    ...
    $(document).on('click', '.btn-add-student-course', function () {
        ...
        $('#student_id').val(selectedStudent.id).trigger('change');
    });
    ...
    function checkSelected(ranking) {  
        if (selectedCourse && selectedStudent) {
            ...
            if (selectedCourse?.ranking_id == selectedStudent?.ranking_id) {
                ...
                $('#show-noti').text(`Hạng bằng đăng ký của học viên là ${selectedStudent?.rankingOfStudent?.name} và đang khác với Hạng bằng của khóa học!`);
    ...
    function loadCourses(vehicleType = 1) {
        return fetch(`/listCourse?vehicle_type=${vehicleType}`)
            .then(response => response.json())
            .then(courses => {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        $(document).on('change', '#student_id', handleStudentChange);
    });
</script>
